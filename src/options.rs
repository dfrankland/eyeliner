pub mod default {
    pub struct Options<'a> {
        ...
        pub inline_pseudo_elements: Option<bool>,
...
pub struct Options<'a> {
    ...
    pub inline_pseudo_elements: bool,
...
impl<'a> Options<'a> {
    pub fn new(opt: default::Options<'a>) -> Self {
        Self {
            ...
            inline_pseudo_elements: opt.inline_pseudo_elements.unwrap_or(false),
